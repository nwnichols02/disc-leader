      ...
      <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="text-center">
                ...
                <div className="font-medium">
                  {gameState.homeGenderRatio?.male || 0}M / {gameState.homeGenderRatio?.female || 0}F
                </div>
              </div>
              <div className="text-center">
                <div className="text-gray-600 text-xs mb-1">Gender Ratio</div>
                <div className="font-medium">
                  {gameState.awayGenderRatio?.male || 0}M / {gameState.awayGenderRatio?.female || 0}F
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="pt-4 border-t border-gray-200">
          <div className="grid grid-cols-2 gap-4 text-sm text-center">
            {/* Timeouts */}
            <div>
              <div className="text-gray-600 text-xs mb-1">Timeouts Remaining</div>
              <div className="font-medium">
                {gameState.homeTimeoutsRemaining} - {gameState.awayTimeoutsRemaining}
              </div>
            </div>
            ...
            {game.format === 'professional' && game.ruleConfig.quarterLength && (
              <div>
                <div className="text-gray-600 text-xs mb-1">Quarter Length</div>
                <div className="font-medium">
