			...
			<div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
				<div className="mb-4">
					<h2 className="text-2xl font-bold mb-2">
						{preview?.title || "Confirm Purchase"}
					</h2>
					{preview?.message && (
				...
				<div className="space-y-3 my-6">
					...
					{preview?.due_today?.price !== undefined && (
						<div className="border-t pt-4 flex justify-between font-bold text-lg">
							<span>Due today:</span>
							<span>
								${preview.due_today.price.toFixed(2)}{" "}
								{preview.due_today.currency}
							</span>
						</div>
					)}
					...
					{preview?.due_next_cycle?.price !== undefined && (
						<div className="flex justify-between text-sm text-gray-600">
							...
							<span>
								${preview.due_next_cycle.price.toFixed(2)}{" "}
								{preview.due_next_cycle.currency}
							</span>
						</div>
					)}
				</div>
